...
function ModalShell({ title, onClose, onSubmit, footer, submitLabel, submitDisabled, cancelLabel, children }) {
  ...
  useEffect(() => {
    ...
    // Compact density is a per-user appearance setting scoped
    // `.lifeflow-app-root.lifeflow-density-compact` (both classes on the
    // same element) — only ever added to the main view's own root before
    // this, so a user with compact mode on saw the main view get tighter
    // spacing but every modal stay at full/default spacing. Mirror the
    // same check here.
...
function AddBookModal({ onClose, onAdd }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(FieldLabel, null, "\u0648\u0636\u0639\u06CC\u062A"),
...
function AddVideoModal({ onClose, onAdd }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(FieldLabel, null, "\u0686\u0647 \u0632\u0645\u0627\u0646\u06CC \u0645\u06CC\u200C\u062E\u0648\u0627\u0645 \u0628\u0628\u06CC\u0646\u0645 (\u0627\u062E\u062A\u06CC\u0627\u0631\u06CC)"),
...
function AddPodcastModal({ onClose, onAdd }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(FieldLabel, null, "\u0686\u0647 \u0632\u0645\u0627\u0646\u06CC \u06AF\u0648\u0634 \u0628\u062F\u0645 (\u0627\u062E\u062A\u06CC\u0627\u0631\u06CC)"),
